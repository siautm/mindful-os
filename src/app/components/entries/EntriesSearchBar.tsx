...
export interface EntriesSearchBarHandle {
  focus: () => void;
  clear: () => void;
}
...
export const EntriesSearchBar = forwardRef<EntriesSearchBarHandle, EntriesSearchBarProps>(
  function EntriesSearchBar({ value, onChange, matchCount, totalCount, noResults }, ref) {
      ...
      <div className="relative mb-2">
        ...
        >
          ...
          <input
            ...
            placeholder="TITLE ONLY · tag:name"
        ...
        <p className="mt-1 text-[9px] font-mono text-slate-600 tracking-wide pl-1">
          / focus · Esc clear · tag:filter
        </p>
